...
public class ConexaoBanco {
    ...
    public static void conectar() {
        ...
        if (isNull(emf) || isNull(em)) {
            ...
            try {
                FileInputStream file = new FileInputStream("config-banco.properties"); //Endereço do arquivo externo de propriedades
                Properties propriedades = new Properties();
                propriedades.load(file);

                emf = Persistence.createEntityManagerFactory("OndeTemConfigJPA", propriedades);
